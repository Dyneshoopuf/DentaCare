...
public class SignUp extends javax.swing.JFrame {
    ...
    private void signup_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signup_buttonActionPerformed
        ...
        String emailtoString = txt_email.getText().trim();
        int email_length = emailtoString.length();
                ...
                if (chkbox_agree.isSelected() && !txt_name.getText().equals(empty) && !txt_username.getText().equals(empty) && !txt_email.getText().equals(empty) && txt_password.getPassword().length != 0
                    ...
                    if (pass_length > 7 && pass_length < 21) {
                        if (email_valid.contains("@") && email_valid.contains(".com")) {
                            if (email_length != 0 && email_length > 6) {
                                ...
                                JOptionPane.showMessageDialog(null, "That is not a valid email", "Sign Up Failed!", JOptionPane.ERROR_MESSAGE);
